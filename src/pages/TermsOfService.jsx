...
export default function TermsOfService() {
  const page = useMemo(() => {
    return pagesData.find(p => p.slug === 'terms-of-service') || null;
  }, []);

  if (!page) {
    return (
      <>
        <SEO title="Terms of Service" description="Read our terms of service to understand the rules and regulations for using our website." />
        <Section>
          <Container>
